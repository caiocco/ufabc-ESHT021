**Importante:** reprodução do escopo da atividade, para fins de documentação e melhor compreensão e aproveitamento do conteúdo do repositório. Adaptação de documento PDF para texto formatado em Markdown.
